# PennyWatt Privacy Policy

_Last updated: 21 August 2026_

PennyWatt is a local energy cost optimizer that times high-wattage
...
PennyWatt does **not** request location, microphone, or contacts
...
PennyWatt makes network requests only to fetch electricity rate data,
...
PennyWatt Pro is a one-time purchase — never a subscription — handled
entirely by Apple's App Store or Google Play. Your card details never
reach PennyWatt; the store only tells the app whether you've
...
- You can back up everything at any time (Settings → Backup &
  ...
  it if it's lost.
- If you add the PennyWatt home-screen widget, only a suggested
...
PennyWatt does not collect personal information from anyone,
including children.
